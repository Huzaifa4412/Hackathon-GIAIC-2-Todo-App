 ...
 * Sign-up page.
 *
 * Allows users to create a new account with email/password or Google OAuth.
 */
"use client"
...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#050505] px-4 py-12 relative overflow-hidden">
      ...
      <motion.div
        className="absolute top-1/4 left-0 w-96 h-96 bg-[#ff4d00] rounded-full opacity-5 blur-3xl"
        animate={{
          scale: [1, 1.2, 1],
      ...
      />
      <motion.div
        className="absolute bottom-1/4 right-0 w-96 h-96 bg-[#ff4d00] rounded-full opacity-5 blur-3xl"
        animate={{
          scale: [1, 1.3, 1],
        ...
        <GlassCard variant="glass" className="space-y-8">
          ...
          >
            <div className="space-y-4">
              ...
              >
                <label htmlFor="confirm-password" className="block text-sm font-semibold text-[#a0a0a0] mb-2">
                  Confirm Password
                </label>
                <input
                  id="confirm-password"
          ...
          >
            ...
            <Link href="/auth/signin" className="font-semibold text-[#ff4d00] hover:text-[#ff6a2c] transition-colors duration-200">
              Sign in
            </Link>
          </motion.p>
        </GlassCard>
